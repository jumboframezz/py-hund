...
if season == "Spring" or season == "Summer":
    chrysanthemums_sum = chrysanthemums * 2
    roses_sum = roses * 4.10
    tulips_sum = tulips * 2.50
else:
    chrysanthemums_sum = chrysanthemums * 3.75
    roses_sum = roses * 4.50
    tulips_sum = tulips * 4.15

sub_total = chrysanthemums_sum + roses_sum + tulips_sum

if holyday == "Y":
    sub_total += sub_total * 0.15

if tulips >= 7 and season == "Spring":
    sub_total -= sub_total * 0.05

if roses >= 10 and season == "Winter":
    sub_total -= sub_total * 0.10

if chrysanthemums + roses + tulips >= 20:
    sub_total -= sub_total * 0.20
