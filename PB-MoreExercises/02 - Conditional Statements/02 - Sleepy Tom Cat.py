...
# свободно време. За да се наспи добре, нормата за игра на Том е 30 000  минути в година. Времето за игра на Том
...
# Пример:
# 20 почивни дни -> работните дни са 345 (365 – 20 = 245).
...
work_days = 365 - vacantion
play_time = (work_days * 63) + (vacantion * 127)


if play_time < 30000:
    print("Tom sleeps well")
    more_time = 30000 - play_time
    play_hours = more_time // 60
    play_minutes = more_time % 60
