...
# на една книжарница, и има намаление за нея, което представлява някакъв процент от общата сума.
...
pendrives_sum = pendrives * 5.80
markers_sum = markers * 7.20
detergent_sum = detergent * 1.20

total_sum = pendrives_sum + markers_sum + detergent_sum

total = total_sum - (total_sum * discount/100)
